...
import { ChartCard, DashboardCard } from "../../../components/card";
      ...
      <div className="w-full flex justify-between items-center gap-6">
        ...
        <div className="flex flex-1 items-center justify-end gap-3">
          ...
          <div className="flex justify-start items-center">
            ...
            <div className="text-black capitalize px-1 flex flex-col items-start justify-start gap-1">
              <H5>{userData ? userData?.name : `Loading...`}</H5>
              <Paragraph variant="muted" className="text-start text-primary">
